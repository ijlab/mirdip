...
# Load MIRZAG
mirzag = pd.read_csv('/gpfs/lb/mirdip5/tools/MIRZAG/data/downloads/seed-mirza-g_all_mirnas_per_gene_scores.tab', sep='\t', header=0)
mirzag = mirzag.rename(columns={'GeneID':'entrez_gene_id', 'miRNA':'mirdip4_mirbase_id', 'Total score without conservation':'mirzag_unconserved_score', 'Total score with conservation':'mirzag_score'})
mirzag = normalize_scores(mirzag, 'mirzag_score', group=1)
mirzag['original_gene_symbol'] = ''
mirzag['original_mirbase_id'] = ''
mirzag['data_source'] = 'mirzag'
mirzag = map_genes_with_hgnc(mirzag, 'entrez_gene_id', 'entrez_id', hgnc=None)
mirzag = mirzag[['symbol', 'mirdip4_mirbase_id', 'mirzag_score', 'mirzag_score_norm', 'data_source', 'original_gene_symbol', 'original_mirbase_id']]
mirzag.replace(r'^\s*$', np.nan, regex=True)
mirzag.dropna(inplace=True)
mirzag = group_mir_gene_pairs_and_take_ranked_product(mirzag, 'mirzag_score_norm')
mirzag = normalize_scores(mirzag, 'mirzag_score_norm', normalized_score_column_name='mirzag_score_norm', group=2)
mirzag.sort_values(by='mirzag_score_norm', inplace=True, ascending=True)
mirzag['original_gene_symbol'] = mirzag['symbol']
mirzag['original_mirbase_id'] = mirzag['mirdip4_mirbase_id']
mirzag = mirzag.drop_duplicates()
mirzag.to_csv('/home/waddelld/rnatools/mirdip5/resources_redo_final/mirzag.txt', sep='\t',index=False,header=False, quoting=csv.QUOTE_MINIMAL)
