...
mirdb_v6 = pd.read_csv('/gpfs/lb/mirdip5/mirdb/miRDB_v6.0_prediction_result.txt', sep='\t', header=None, names=['mirdip4_mirbase_id', 'refseq_id', 'mirdb_v6_score'])
# get rid of non-human
mirdb_v6 = mirdb_v6[mirdb_v6['mirdip4_mirbase_id'].str.startswith('hsa')]
mirdb_v6 = normalize_scores(mirdb_v6, 'mirdb_v6_score', group=1)
mirdb_v6['original_gene_symbol'] = ''
mirdb_v6['original_mirbase_id'] = ''
mirdb_v6['data_source'] = 'miRDB_v6'
mirdb_v6 = map_genes_with_hgnc(mirdb_v6, 'refseq_id', 'refseq_accession', hgnc=None)
mirdb_v6 = mirdb_v6[['symbol', 'mirdip4_mirbase_id', 'mirdb_v6_score', 'mirdb_v6_score_norm', 'data_source', 'original_gene_symbol', 'original_mirbase_id']]
mirdb_v6.replace(r'^\s*$', np.nan, regex=True)
mirdb_v6.dropna(inplace=True)
mirdb_v6.drop_duplicates()
mirdb_v6 = group_mir_gene_pairs_and_take_ranked_product(mirdb_v6, 'mirdb_v6_score_norm')
mirdb_v6 = normalize_scores(mirdb_v6, 'mirdb_v6_score_norm', normalized_score_column_name='mirdb_v6_score_norm', group=2)
mirdb_v6.sort_values(by='mirdb_v6_score_norm', inplace=True, ascending=True)
mirdb_v6['original_gene_symbol'] = mirdb_v6['symbol']
mirdb_v6['original_mirbase_id'] = mirdb_v6['mirdip4_mirbase_id']
mirdb_v6 = mirdb_v6.drop_duplicates()
mirdb_v6.to_csv('/home/waddelld/rnatools/mirdip5/resources_redo_final/mirdb_v6.txt', sep='\t',index=False,header=False, quoting=csv.QUOTE_MINIMAL)
