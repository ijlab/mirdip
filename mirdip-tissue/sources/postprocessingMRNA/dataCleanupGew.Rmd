---
title: "Processing GeW gene expression data"
...
```{r}
write.table(data_long_final, "./gew_longData.txt", sep = "\t", row.names = F, col.names = T, quote = F)
write.table(unique(data_long_final[,1]), "./gew_genes.txt", sep = "\t", row.names = F, col.names = T, quote = F)
writeLines(as.character(unique(data_long_final$Tissue)), "./gew_tissues.txt")
```
