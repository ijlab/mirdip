---
title: "Processing Varghese gene expression data"
...
### Write to file
```{r}
write.table(data_long_final, "./varghese_longData.txt", sep = "\t", row.names = F, col.names = T, quote = F)
write.table(unique(data_long_final[,1]), "./varghese_genes.txt", sep = "\t", row.names = F, col.names = T, quote = F)
writeLines(as.character(unique(data_long_final$Tissue)), "./varghese_tissues.txt")
```
